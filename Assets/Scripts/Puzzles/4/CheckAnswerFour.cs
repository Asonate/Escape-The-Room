...
public class CheckAnswerFour : MonoBehaviour
{
    ...
    public IEnumerator DisplayMessage()
    {
        ...
        Text text = PuzzleFour.CheckAnswer() ? transform.Find("Success Text").GetComponent<Text>() : transform.Find("Failure Text").GetComponent<Text>();
