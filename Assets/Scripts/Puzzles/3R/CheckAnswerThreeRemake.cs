...
public class CheckAnswerThreeRemake : MonoBehaviour
{
    ...
    public IEnumerator DisplayMessage()
    {
        ...
        Text text = PuzzleThreeRemake.CheckAnswer() ? transform.Find("Success Text").GetComponent<Text>() : transform.Find("Failure Text").GetComponent<Text>();
